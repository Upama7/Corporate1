...
function FooterTop() {
  return (
    <div className="bg-white  px-16 md:px-0 py-8">
      <div className="container mx-auto xl:max-w-[1100px] flex flex-col md:flex-row justify-between items-start md:items-center gap-10">
